  ...
  return (
    <>
      <div className="background">
        <div className=" grid lg:grid-cols-2 max-w-screen-2xl mx-auto space-x-32 lg:py-32 py-24">
          <div className="px-12 lg:pl-[18.75rem] space-y-8 lg:py-32">
            ...
            <h3 className="text-lightbrown leading-[3.375rem] text-[2.3125rem] font-normal font-super lg:max-w-lg">
          ...
          <div className="lg:flex lg:space-x-14 lg:py-32 space-y-8">
            <div className="flex flex-col space-y-8 pt-24 lg:py-12">
              <picture>
                <img
